          ...
          >
            <Stack spacing={1.25} height="100%">
              <Stack direction="row" spacing={1} alignItems="center" flexWrap="wrap" useFlexGap>
                ...
                <Typography variant="h6" fontWeight={950}>{item.name}</Typography>
              ...
              <Box>
                ...
                <Typography variant="h4" fontWeight={950}>{formatMoney(item.price)}</Typography>
              </Box>
              ...
              <Paper sx={{ p: 1.25, borderRadius: 3, bgcolor: 'action.hover', boxShadow: 'none' }}>
